...
export function CTA() {
  const { t } = useLanguage();
  const ctaTitle = t("cta.sectionTitle").split("\n");
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            {ctaTitle[1] ? (
              <>
                {" "}
                <span className="text-white/90 font-extrabold">{ctaTitle[1]}</span>
              </>
            ) : null}
          </h2>
          
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
            {t("cta.sectionSubtitle.part1")}{" "}
            <strong>{t("cta.sectionSubtitle.highlight")}</strong>{" "}
            {t("cta.sectionSubtitle.part2")}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto bg-white/10 rounded-2xl p-8 backdrop-blur-sm">
            <div className="text-center">
              ...
              <div className="text-white/90 font-semibold">{t("cta.badges.fast")}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2">💎</div>
              <div className="text-white/90 font-semibold">{t("cta.badges.quality")}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2">📈</div>
              <div className="text-white/90 font-semibold">{t("cta.badges.results")}</div>
            </div>
          </div>
        </div>
      </div>
